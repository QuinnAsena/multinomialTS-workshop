...
Welcome to our workshop on how to use the `multinomialTS` package. First things first, let's make sure you have all the necessary packages installed. Follow the instructions on the [README](https://github.com/QuinnAsena/multinomialTS-workshop#welcome-to-the-multinomialts-workshop) and then try rendering this document. This may take a few minutes, so while that is running, I'm going to go through a few slides. If this document fails to render, something has gone wrong and one of the workshop helpers will assist you.
